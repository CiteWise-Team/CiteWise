          ...
          <div className="col-lg-6 d-none d-lg-flex align-items-center justify-content-center" style={{ 
            ...
            <div className="w-100" style={{ 
              ...
              <p className="mb-4 text-center" style={{ 
                ...
                Sign in to continue your research journey. Access your papers,
                track progress, and discover research gaps effortlessly.
              </p>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  <div className="d-flex justify-content-between align-items-center">
                    ...
                    onMouseLeave={(e) => e.target.style.color = "rgba(161,161,181,0.6)"}
                    >
                      Forgot Password?
                    </a>
                  </div>
